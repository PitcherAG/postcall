...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground uppercase hover:opacity-85',
        destructive:
          'bg-destructive text-destructive-foreground uppercase hover:opacity-85',
        outline:
          'border border-input bg-background uppercase hover:bg-accent hover:text-accent-foreground',
        secondary:
